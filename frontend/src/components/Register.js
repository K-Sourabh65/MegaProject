          ...
          <Row className="justify-content-center form-bg-image" style={{ backgroundImage: `url(${BgImage})` }}>
            <Col xs={12} className="d-flex align-items-center justify-content-center">
              <div className="mb-4 mb-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                ...
                <Form className="mt-4" onSubmit={Add}>
                <Form.Group id="name" className="mb-4">
                    ...
                    <InputGroup>
                      ...
                      <Form.Control autoFocus required type="text" placeholder="Name" onChange={(e) => setStudentName(e.target.value)}/>
                    </InputGroup>
                  </Form.Group>
                  <Form.Group id="email" className="mb-4">
                    ...
                    <InputGroup>
                      ...
                      <Form.Control autoFocus required type="email" placeholder="example@company.com" onChange={(e) => setStudentEmail(e.target.value)}/>
                    </InputGroup>
                  </Form.Group>
